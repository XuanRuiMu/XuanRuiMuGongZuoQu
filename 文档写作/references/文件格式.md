...
**Transcription**: [Transcribed text appears here...]
```
...
1. **Split very large PDFs before conversion** for better performance
...
1. **Complex animations won't be captured** - static content only

### Excel Best Practices

1. **Large spreadsheets** may take time to convert

1. **Formulas are converted to their calculated values**

1. **Multiple sheets** are all included in output

1. **Charts become text descriptions** (use AI for better descriptions)
...
1. **High-resolution images** may take longer to process

### Audio Best Practices

1. **Clear audio** produces better transcriptions

1. **Long recordings** may take significant time

1. **Consider splitting long audio files** for faster processing
