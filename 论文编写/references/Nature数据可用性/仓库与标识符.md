...
Use this file when selecting repositories, checking accession strategy, or writing dataset citations.
...
For reused public data, cite the dataset in the reference list when the dataset supports conclusions. Mentioning it only
in the Data Availability statement may be insufficient.
